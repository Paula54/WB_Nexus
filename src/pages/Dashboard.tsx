...
export default function Dashboard() {
  ...
  // Generate smart insights based on project state
  ...
  if (stats.draftPosts > 0) {
    insights.push({
      id: "draft-posts",
      icon: <Instagram className="h-5 w-5 text-purple-400" />,
  ...
  // Always add a positive insight if everything is going well
  ...
  const quickStats = [
    { label: "Potenciais Clientes", value: stats.leads, icon: Users, color: "text-blue-400" },
    { label: "Clientes Quentes", value: stats.hotLeads, icon: Flame, color: "text-orange-500" },
    { label: "Posts Publicados", value: stats.publishedPosts, icon: TrendingUp, color: "text-green-400" },
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Aqui está o que a IA identificou para ti hoje.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="glass">
          <CardHeader>
            ...
            <CardDescription>
              Estado das tuas publicações nas redes sociais
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
        ...
        <Card className="glass">
          <CardHeader>
            ...
            <CardDescription>
              Contactos recebidos e classificados pela IA
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
